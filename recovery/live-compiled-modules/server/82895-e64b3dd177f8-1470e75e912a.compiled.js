...
// Deployed source path: /home/asifnawaz/git/dermaup-hair-oil/app/api/admin/content/products/route.ts
// Project-relative source path: app/api/admin/content/products/route.ts
// Module ID: 82895
// Deployment location(s): dist/worker.js
// Captured factory SHA-256: 1470e75e912a5d1565b638c8d2fd87472abb0a3b588966ec3ded926eb7cef7f9
...
((a2, b4, c2) => {
          ...
          var e = c2(95736), f = c2(9117), g2 = c2(4044), h = c2(39326), i = c2(32324), j3 = c2(261), k3 = c2(54290), l = c2(85328), m2 = c2(38928), n = c2(46595), o = c2(3421), p2 = c2(17679), q3 = c2(41681), r = c2(63446), s = c2(86439), t = c2(51356), u = c2(10641), v2 = c2(16780), w3 = c2(71559), x3 = c2(91132), y3 = c2(66147), z3 = c2(65471);
          async function A2(a3) {
            ...
            let d2 = (0, x3.Lf)(c3), e2 = await d2.select().from(x3.ZE).orderBy((0, w3.Y)(x3.ZE.sortOrder)).all();
            return u.NextResponse.json({ success: true, data: e2.map((a4) => ({ ...a4, parsedData: (0, z3.$)(a4.data) })) });
          }
          __name(A2, "A2");
          async function B2(a3) {
            ...
            let c3 = (0, x3.qK)();
            if (!c3) return u.NextResponse.json({ success: false, error: "DB not available" }, { status: 500 });
            let d2 = (0, x3.Lf)(c3), e2 = await a3.json(), f2 = (0, x3.$C)("prod");
            return await d2.insert(x3.ZE).values({ id: f2, slug: e2.slug, name: e2.name, nameUr: e2.nameUr || null, sku: e2.sku || null, data: JSON.stringify(e2.data), active: e2.active ?? true, sortOrder: e2.sortOrder ?? 0 }), (0, v2.revalidateTag)(`product:${e2.slug}`), u.NextResponse.json({ success: true, data: { id: f2 } }, { status: 201 });
          }
          __name(B2, "B2");
          let C2 = new e.AppRouteRouteModule({ definition: { kind: f.RouteKind.APP_ROUTE, page: "/api/admin/content/products/route", pathname: "/api/admin/content/products", filename: "route", bundlePath: "app/api/admin/content/products/route" }, distDir: ".next", relativeProjectDir: "", resolvedPagePath: "/home/asifnawaz/git/dermaup-hair-oil/app/api/admin/content/products/route.ts", nextConfigOutput: "standalone", userland: d }), { workAsyncStorage: D2, workUnitAsyncStorage: E2, serverHooks: F2 } = C2;
          function G3() {
          ...
          async function H3(a3, b5, c3) {
            var d2;
            let e2 = "/api/admin/content/products/route";
            e2 === "/index" && (e2 = "/");
