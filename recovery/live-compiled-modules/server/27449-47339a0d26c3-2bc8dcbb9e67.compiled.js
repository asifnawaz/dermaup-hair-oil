...
// Deployed source path: /home/asifnawaz/git/dermaup-hair-oil/app/api/admin/content/products/[id]/route.ts
// Project-relative source path: app/api/admin/content/products/[id]/route.ts
// Module ID: 27449
// Deployment location(s): dist/worker.js
// Captured factory SHA-256: 2bc8dcbb9e6728992bcaaea264748f1c906b30ef80c20130395ba7c27172dfc4
...
((a2, b4, c2) => {
          ...
          async function A2(a3, { params: b5 }) {
            ...
            let f2 = (0, x3.Lf)(e2), g3 = await f2.select().from(x3.ZE).where((0, w3.eq)(x3.ZE.id, d2)).get();
          ...
          async function B2(a3, { params: b5 }) {
            ...
            let { id: d2 } = await b5, e2 = (0, x3.qK)();
            if (!e2) return u.NextResponse.json({ success: false, error: "DB not available" }, { status: 500 });
            let f2 = (0, x3.Lf)(e2), g3 = await a3.json(), h2 = { updatedAt: (/* @__PURE__ */ new Date()).toISOString() };
            g3.slug !== void 0 && (h2.slug = g3.slug), g3.name !== void 0 && (h2.name = g3.name), g3.nameUr !== void 0 && (h2.nameUr = g3.nameUr), g3.sku !== void 0 && (h2.sku = g3.sku), g3.data !== void 0 && (h2.data = JSON.stringify(g3.data)), g3.active !== void 0 && (h2.active = g3.active), g3.sortOrder !== void 0 && (h2.sortOrder = g3.sortOrder), await f2.update(x3.ZE).set(h2).where((0, w3.eq)(x3.ZE.id, d2));
            let i2 = await f2.select().from(x3.ZE).where((0, w3.eq)(x3.ZE.id, d2)).get();
            return i2 && (0, v2.revalidateTag)(`product:${i2.slug}`), u.NextResponse.json({ success: true });
          }
          __name(B2, "B2");
          async function C2(a3, { params: b5 }) {
            ...
            if (!e2) return u.NextResponse.json({ success: false, error: "DB not available" }, { status: 500 });
            let f2 = (0, x3.Lf)(e2), g3 = await f2.select().from(x3.ZE).where((0, w3.eq)(x3.ZE.id, d2)).get();
            return await f2.delete(x3.ZE).where((0, w3.eq)(x3.ZE.id, d2)), g3 && (0, v2.revalidateTag)(`product:${g3.slug}`), u.NextResponse.json({ success: true });
          }
          __name(C2, "C2");
          let D2 = new e.AppRouteRouteModule({ definition: { kind: f.RouteKind.APP_ROUTE, page: "/api/admin/content/products/[id]/route", pathname: "/api/admin/content/products/[id]", filename: "route", bundlePath: "app/api/admin/content/products/[id]/route" }, distDir: ".next", relativeProjectDir: "", resolvedPagePath: "/home/asifnawaz/git/dermaup-hair-oil/app/api/admin/content/products/[id]/route.ts", nextConfigOutput: "standalone", userland: d }), { workAsyncStorage: E2, workUnitAsyncStorage: F2, serverHooks: G3 } = D2;
          function H3() {
          ...
          async function I3(a3, b5, c3) {
            var d2;
            let e2 = "/api/admin/content/products/[id]/route";
            e2 === "/index" && (e2 = "/");
