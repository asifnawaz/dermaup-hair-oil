...
// Deployed source path: /home/asifnawaz/git/dermaup-hair-oil/app/api/admin/content/pages/[id]/sections/[sectionId]/route.ts
// Project-relative source path: app/api/admin/content/pages/[id]/sections/[sectionId]/route.ts
// Module ID: 30745
// Deployment location(s): dist/worker.js
// Captured factory SHA-256: 8beb470b4b81a1fc1bb9fef21078ee7e745b93174ce4b08abc8e6788a71e259e
...
((a2, b4, c2) => {
          ...
          var d = {};
          c2.r(d), c2.d(d, { DELETE: /* @__PURE__ */ __name(() => z3, "DELETE") });
          var e = c2(95736), f = c2(9117), g2 = c2(4044), h = c2(39326), i = c2(32324), j3 = c2(261), k3 = c2(54290), l = c2(85328), m2 = c2(38928), n = c2(46595), o = c2(3421), p2 = c2(17679), q3 = c2(41681), r = c2(63446), s = c2(86439), t = c2(51356), u = c2(10641), v2 = c2(16780), w3 = c2(48689), x3 = c2(91132), y3 = c2(66147);
          async function z3(a3, { params: b5 }) {
            ...
            let { id: d2, sectionId: e2 } = await b5, f2 = (0, x3.qK)();
            if (!f2) return u.NextResponse.json({ success: false, error: "DB not available" }, { status: 500 });
            let g3 = (0, x3.Lf)(f2);
            await g3.delete(x3.Kz).where((0, w3.eq)(x3.Kz.id, e2));
            let h2 = await g3.select().from(x3.Bd).where((0, w3.eq)(x3.Bd.id, d2)).get();
            return h2 && (0, v2.revalidateTag)(`page:${h2.slug}`), u.NextResponse.json({ success: true });
          }
          __name(z3, "z3");
          let A2 = new e.AppRouteRouteModule({ definition: { kind: f.RouteKind.APP_ROUTE, page: "/api/admin/content/pages/[id]/sections/[sectionId]/route", pathname: "/api/admin/content/pages/[id]/sections/[sectionId]", filename: "route", bundlePath: "app/api/admin/content/pages/[id]/sections/[sectionId]/route" }, distDir: ".next", relativeProjectDir: "", resolvedPagePath: "/home/asifnawaz/git/dermaup-hair-oil/app/api/admin/content/pages/[id]/sections/[sectionId]/route.ts", nextConfigOutput: "standalone", userland: d }), { workAsyncStorage: B2, workUnitAsyncStorage: C2, serverHooks: D2 } = A2;
          function E2() {
          ...
          async function F2(a3, b5, c3) {
            var d2;
            let e2 = "/api/admin/content/pages/[id]/sections/[sectionId]/route";
            e2 === "/index" && (e2 = "/");
