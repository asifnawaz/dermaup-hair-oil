...
// Deployed source path: /home/asifnawaz/git/dermaup-hair-oil/app/api/coupons/validate/route.ts
// Project-relative source path: app/api/coupons/validate/route.ts
// Module ID: 34881
// Deployment location(s): dist/worker.js
// Captured factory SHA-256: 9ee10c7dc5d2b8541af3687abde111bae1c0c862f75bd088ba4e59a179c99627
...
((a2, b4, c2) => {
          ...
          var d = {};
          c2.r(d), c2.d(d, { POST: /* @__PURE__ */ __name(() => x3, "POST") });
          var e = c2(95736), f = c2(9117), g2 = c2(4044), h = c2(39326), i = c2(32324), j3 = c2(261), k3 = c2(54290), l = c2(85328), m2 = c2(38928), n = c2(46595), o = c2(3421), p2 = c2(17679), q3 = c2(41681), r = c2(63446), s = c2(86439), t = c2(51356), u = c2(10641), v2 = c2(91132), w3 = c2(98190);
          async function x3(a3) {
            try {
              let { code: b5, subtotal: c3 } = await a3.json();
              if (!b5 || typeof b5 != "string") return u.NextResponse.json({ success: false, error: "Coupon code is required" }, { status: 400 });
              let d2 = (0, v2.qK)();
              if (!d2) return u.NextResponse.json({ success: false, error: "Service unavailable" }, { status: 503 });
              let e2 = (0, v2.Lf)(d2), f2 = await (0, w3.m)(e2, b5, typeof c3 == "number" ? c3 : 0);
              return f2.success ? u.NextResponse.json({ success: true, data: f2.data }) : u.NextResponse.json({ success: false, error: f2.error }, { status: f2.status });
            } catch (a4) {
              return console.error("Coupon validation error:", a4), u.NextResponse.json({ success: false, error: "Failed to validate coupon" }, { status: 500 });
            }
          }
          __name(x3, "x3");
          let y3 = new e.AppRouteRouteModule({ definition: { kind: f.RouteKind.APP_ROUTE, page: "/api/coupons/validate/route", pathname: "/api/coupons/validate", filename: "route", bundlePath: "app/api/coupons/validate/route" }, distDir: ".next", relativeProjectDir: "", resolvedPagePath: "/home/asifnawaz/git/dermaup-hair-oil/app/api/coupons/validate/route.ts", nextConfigOutput: "standalone", userland: d }), { workAsyncStorage: z3, workUnitAsyncStorage: A2, serverHooks: B2 } = y3;
          function C2() {
          ...
          async function D2(a3, b5, c3) {
            var d2;
            let e2 = "/api/coupons/validate/route";
            e2 === "/index" && (e2 = "/");
