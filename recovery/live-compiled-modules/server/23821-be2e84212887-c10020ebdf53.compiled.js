...
// Deployed source path: /home/asifnawaz/git/dermaup-hair-oil/app/api/admin/settings/route.ts
// Project-relative source path: app/api/admin/settings/route.ts
// Module ID: 23821
// Deployment location(s): dist/worker.js
// Captured factory SHA-256: c10020ebdf53cd94129cec9c255179e4720ece543092ae57cb54761093ee34cd
...
((a2, b4, c2) => {
          ...
          var d = {};
          c2.r(d), c2.d(d, { GET: /* @__PURE__ */ __name(() => A2, "GET"), PUT: /* @__PURE__ */ __name(() => B2, "PUT") });
          var e = c2(95736), f = c2(9117), g2 = c2(4044), h = c2(39326), i = c2(32324), j3 = c2(261), k3 = c2(54290), l = c2(85328), m2 = c2(38928), n = c2(46595), o = c2(3421), p2 = c2(17679), q3 = c2(41681), r = c2(63446), s = c2(86439), t = c2(51356), u = c2(10641), v2 = c2(16780), w3 = c2(48689), x3 = c2(91132), y3 = c2(66147), z3 = c2(65471);
          async function A2(a3) {
            ...
            let d2 = (0, x3.Lf)(c3), e2 = await d2.select().from(x3.fs).all(), f2 = {};
            for (let a4 of e2) f2[a4.key] = (0, z3.j)(a4.value, a4.value);
            return u.NextResponse.json({ success: true, data: f2 });
          }
          __name(A2, "A2");
          async function B2(a3) {
            ...
            let c3 = (0, x3.qK)();
            if (!c3) return u.NextResponse.json({ success: false, error: "DB not available" }, { status: 500 });
            let d2 = (0, x3.Lf)(c3), e2 = await a3.json(), f2 = (/* @__PURE__ */ new Date()).toISOString();
            for (let [a4, b6] of Object.entries(e2)) {
              let c4 = typeof b6 == "string" ? b6 : JSON.stringify(b6);
              await d2.select().from(x3.fs).where((0, w3.eq)(x3.fs.key, a4)).get() ? await d2.update(x3.fs).set({ value: c4, updatedAt: f2 }).where((0, w3.eq)(x3.fs.key, a4)) : await d2.insert(x3.fs).values({ key: a4, value: c4, updatedAt: f2 });
            }
            return (0, v2.revalidateTag)("settings"), u.NextResponse.json({ success: true });
          }
          __name(B2, "B2");
          let C2 = new e.AppRouteRouteModule({ definition: { kind: f.RouteKind.APP_ROUTE, page: "/api/admin/settings/route", pathname: "/api/admin/settings", filename: "route", bundlePath: "app/api/admin/settings/route" }, distDir: ".next", relativeProjectDir: "", resolvedPagePath: "/home/asifnawaz/git/dermaup-hair-oil/app/api/admin/settings/route.ts", nextConfigOutput: "standalone", userland: d }), { workAsyncStorage: D2, workUnitAsyncStorage: E2, serverHooks: F2 } = C2;
          function G3() {
          ...
          async function H3(a3, b5, c3) {
            var d2;
            let e2 = "/api/admin/settings/route";
            e2 === "/index" && (e2 = "/");
