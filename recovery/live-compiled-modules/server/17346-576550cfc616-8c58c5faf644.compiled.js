...
// Deployed source path: /home/asifnawaz/git/dermaup-hair-oil/app/api/admin/content/pages/[id]/route.ts
// Project-relative source path: app/api/admin/content/pages/[id]/route.ts
// Module ID: 17346
// Deployment location(s): dist/worker.js
// Captured factory SHA-256: 8c58c5faf644d42721194681ea89ec0a39fc96d8ba9fb4b19c5eecb7126d2e59
...
((a2, b4, c2) => {
          ...
          var d = {};
          c2.r(d), c2.d(d, { DELETE: /* @__PURE__ */ __name(() => D2, "DELETE"), GET: /* @__PURE__ */ __name(() => B2, "GET"), PUT: /* @__PURE__ */ __name(() => C2, "PUT") });
          ...
          async function B2(a3, { params: b5 }) {
            ...
            let f2 = (0, y3.Lf)(e2), g3 = await f2.select().from(y3.Bd).where((0, w3.eq)(y3.Bd.id, d2)).get();
            if (!g3) return u.NextResponse.json({ success: false, error: "Not found" }, { status: 404 });
            let h2 = await f2.select().from(y3.Kz).where((0, w3.eq)(y3.Kz.pageId, d2)).orderBy((0, x3.Y)(y3.Kz.sortOrder)).all();
            return u.NextResponse.json({ success: true, data: { ...g3, parsedMeta: (0, A2.$)(g3.meta), sections: h2.map((a4) => ({ ...a4, parsedConfig: (0, A2.$)(a4.config) })) } });
          }
          __name(B2, "B2");
          async function C2(a3, { params: b5 }) {
            ...
            let { id: d2 } = await b5, e2 = (0, y3.qK)();
            if (!e2) return u.NextResponse.json({ success: false, error: "DB not available" }, { status: 500 });
            let f2 = (0, y3.Lf)(e2), g3 = await a3.json(), h2 = { updatedAt: (/* @__PURE__ */ new Date()).toISOString() };
            g3.slug !== void 0 && (h2.slug = g3.slug), g3.productId !== void 0 && (h2.productId = g3.productId), g3.title !== void 0 && (h2.title = g3.title), g3.meta !== void 0 && (h2.meta = JSON.stringify(g3.meta)), g3.active !== void 0 && (h2.active = g3.active), await f2.update(y3.Bd).set(h2).where((0, w3.eq)(y3.Bd.id, d2));
            let i2 = await f2.select().from(y3.Bd).where((0, w3.eq)(y3.Bd.id, d2)).get();
            return i2 && (0, v2.revalidateTag)(`page:${i2.slug}`), u.NextResponse.json({ success: true });
          }
          __name(C2, "C2");
          async function D2(a3, { params: b5 }) {
            ...
            if (!e2) return u.NextResponse.json({ success: false, error: "DB not available" }, { status: 500 });
            let f2 = (0, y3.Lf)(e2), g3 = await f2.select().from(y3.Bd).where((0, w3.eq)(y3.Bd.id, d2)).get();
            return await f2.delete(y3.Kz).where((0, w3.eq)(y3.Kz.pageId, d2)), await f2.delete(y3.Bd).where((0, w3.eq)(y3.Bd.id, d2)), g3 && (0, v2.revalidateTag)(`page:${g3.slug}`), u.NextResponse.json({ success: true });
          }
          __name(D2, "D2");
          let E2 = new e.AppRouteRouteModule({ definition: { kind: f.RouteKind.APP_ROUTE, page: "/api/admin/content/pages/[id]/route", pathname: "/api/admin/content/pages/[id]", filename: "route", bundlePath: "app/api/admin/content/pages/[id]/route" }, distDir: ".next", relativeProjectDir: "", resolvedPagePath: "/home/asifnawaz/git/dermaup-hair-oil/app/api/admin/content/pages/[id]/route.ts", nextConfigOutput: "standalone", userland: d }), { workAsyncStorage: F2, workUnitAsyncStorage: G3, serverHooks: H3 } = E2;
          function I3() {
          ...
          async function J2(a3, b5, c3) {
            var d2;
            let e2 = "/api/admin/content/pages/[id]/route";
            e2 === "/index" && (e2 = "/");
