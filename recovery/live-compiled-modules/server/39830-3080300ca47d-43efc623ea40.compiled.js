...
// Deployed source path: /home/asifnawaz/git/dermaup-hair-oil/app/api/admin/media/[id]/route.ts
// Project-relative source path: app/api/admin/media/[id]/route.ts
// Module ID: 39830
// Deployment location(s): dist/worker.js
// Captured factory SHA-256: 43efc623ea40f39dcc9c39a58124a2160b0512c6916f93743840f598c4b432cd
...
((a2, b4, c2) => {
          ...
          async function y3(a3, { params: b5 }) {
            ...
            let h2 = (0, w3.nk)();
            if (!h2) return u.NextResponse.json({ success: false, error: "Media bucket not available" }, { status: 500 });
            try {
              await h2.delete(g3.key);
            } catch {
            }
            return await f2.delete(w3.$_).where((0, v2.eq)(w3.$_.id, d2)), u.NextResponse.json({ success: true });
          }
          __name(y3, "y3");
          let z3 = new e.AppRouteRouteModule({ definition: { kind: f.RouteKind.APP_ROUTE, page: "/api/admin/media/[id]/route", pathname: "/api/admin/media/[id]", filename: "route", bundlePath: "app/api/admin/media/[id]/route" }, distDir: ".next", relativeProjectDir: "", resolvedPagePath: "/home/asifnawaz/git/dermaup-hair-oil/app/api/admin/media/[id]/route.ts", nextConfigOutput: "standalone", userland: d }), { workAsyncStorage: A2, workUnitAsyncStorage: B2, serverHooks: C2 } = z3;
          function D2() {
          ...
          async function E2(a3, b5, c3) {
            var d2;
            let e2 = "/api/admin/media/[id]/route";
            e2 === "/index" && (e2 = "/");
