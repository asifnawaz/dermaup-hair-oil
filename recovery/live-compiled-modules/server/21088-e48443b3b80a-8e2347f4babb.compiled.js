...
// Deployed source path: /home/asifnawaz/git/dermaup-hair-oil/app/api/admin/auth/logout/route.ts
// Project-relative source path: app/api/admin/auth/logout/route.ts
// Module ID: 21088
// Deployment location(s): dist/worker.js
// Captured factory SHA-256: 8e2347f4babbaa66c702ffb55fdd6c180b6c09b86b3bd0da9b88e0920356cce5
...
((a2, b4, c2) => {
          ...
          var e = c2(95736), f = c2(9117), g2 = c2(4044), h = c2(39326), i = c2(32324), j3 = c2(261), k3 = c2(54290), l = c2(85328), m2 = c2(38928), n = c2(46595), o = c2(3421), p2 = c2(17679), q3 = c2(41681), r = c2(63446), s = c2(86439), t = c2(51356), u = c2(10641), v2 = c2(66147);
          async function w3() {
            return await (0, v2.C0)(), u.NextResponse.json({ success: true, message: "Logged out successfully" });
          }
          __name(w3, "w3");
          let x3 = new e.AppRouteRouteModule({ definition: { kind: f.RouteKind.APP_ROUTE, page: "/api/admin/auth/logout/route", pathname: "/api/admin/auth/logout", filename: "route", bundlePath: "app/api/admin/auth/logout/route" }, distDir: ".next", relativeProjectDir: "", resolvedPagePath: "/home/asifnawaz/git/dermaup-hair-oil/app/api/admin/auth/logout/route.ts", nextConfigOutput: "standalone", userland: d }), { workAsyncStorage: y3, workUnitAsyncStorage: z3, serverHooks: A2 } = x3;
          function B2() {
          ...
          async function C2(a3, b5, c3) {
            var d2;
            let e2 = "/api/admin/auth/logout/route";
            e2 === "/index" && (e2 = "/");
