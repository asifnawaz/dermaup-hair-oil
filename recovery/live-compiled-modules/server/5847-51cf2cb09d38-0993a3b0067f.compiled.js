...
// Deployed source path: /home/asifnawaz/git/dermaup-hair-oil/app/api/admin/subscribers/[id]/route.ts
// Project-relative source path: app/api/admin/subscribers/[id]/route.ts
// Module ID: 5847
// Deployment location(s): dist/worker.js
// Captured factory SHA-256: 0993a3b0067fe6caed1c069a0c45c30d29d28a88086e1085383420ef4cb61bb4
...
((a2, b4, c2) => {
          ...
          var d = {};
          c2.r(d), c2.d(d, { DELETE: /* @__PURE__ */ __name(() => z3, "DELETE"), PATCH: /* @__PURE__ */ __name(() => y3, "PATCH") });
          var e = c2(95736), f = c2(9117), g2 = c2(4044), h = c2(39326), i = c2(32324), j3 = c2(261), k3 = c2(54290), l = c2(85328), m2 = c2(38928), n = c2(46595), o = c2(3421), p2 = c2(17679), q3 = c2(41681), r = c2(63446), s = c2(86439), t = c2(51356), u = c2(10641), v2 = c2(48689), w3 = c2(91132), x3 = c2(66147);
          async function y3(a3, { params: b5 }) {
            let c3 = await (0, x3.K5)(a3);
            if (!(0, x3.oC)(c3)) return u.NextResponse.json({ success: false, error: "Not authenticated" }, { status: 401 });
            try {
              let { id: c4 } = await b5, d2 = await a3.json(), e2 = (0, w3.qK)();
              if (!e2) return u.NextResponse.json({ success: false, error: "DB unavailable" }, { status: 503 });
              let f2 = (0, w3.Lf)(e2), g3 = {};
              return typeof d2.isActive == "boolean" && (g3.isActive = d2.isActive), Object.keys(g3).length === 0 ? u.NextResponse.json({ success: false, error: "No valid fields to update" }, { status: 400 }) : (await f2.update(w3._s).set(g3).where((0, v2.eq)(w3._s.id, c4)), u.NextResponse.json({ success: true, data: { id: c4 } }));
            } catch (a4) {
              return console.error("Subscriber update error:", a4), u.NextResponse.json({ success: false, error: "Failed to update subscriber" }, { status: 500 });
            }
          }
          __name(y3, "y3");
          async function z3(a3, { params: b5 }) {
            ...
            if (!(0, x3.oC)(c3)) return u.NextResponse.json({ success: false, error: "Not authenticated" }, { status: 401 });
            try {
              let { id: a4 } = await b5, c4 = (0, w3.qK)();
              return c4 ? (await (0, w3.Lf)(c4).delete(w3._s).where((0, v2.eq)(w3._s.id, a4)), u.NextResponse.json({ success: true, data: { id: a4 } })) : u.NextResponse.json({ success: false, error: "DB unavailable" }, { status: 503 });
            } catch (a4) {
              return console.error("Subscriber delete error:", a4), u.NextResponse.json({ success: false, error: "Failed to delete subscriber" }, { status: 500 });
            }
          }
          __name(z3, "z3");
          let A2 = new e.AppRouteRouteModule({ definition: { kind: f.RouteKind.APP_ROUTE, page: "/api/admin/subscribers/[id]/route", pathname: "/api/admin/subscribers/[id]", filename: "route", bundlePath: "app/api/admin/subscribers/[id]/route" }, distDir: ".next", relativeProjectDir: "", resolvedPagePath: "/home/asifnawaz/git/dermaup-hair-oil/app/api/admin/subscribers/[id]/route.ts", nextConfigOutput: "standalone", userland: d }), { workAsyncStorage: B2, workUnitAsyncStorage: C2, serverHooks: D2 } = A2;
          function E2() {
          ...
          async function F2(a3, b5, c3) {
            var d2;
            let e2 = "/api/admin/subscribers/[id]/route";
            e2 === "/index" && (e2 = "/");
