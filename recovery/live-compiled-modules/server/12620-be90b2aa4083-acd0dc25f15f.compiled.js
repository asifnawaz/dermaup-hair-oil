...
// Deployed source path: /home/asifnawaz/git/dermaup-hair-oil/app/api/admin/orders/[id]/payment-proof/route.ts
// Project-relative source path: app/api/admin/orders/[id]/payment-proof/route.ts
// Module ID: 12620
// Deployment location(s): dist/worker.js
// Captured factory SHA-256: acd0dc25f15f584f4c99a2a8f9b62dce32eb345cc3edc76ed80b61846d18c14f
...
((a2, b4, c2) => {
          ...
          var e = c2(95736), f = c2(9117), g2 = c2(4044), h = c2(39326), i = c2(32324), j3 = c2(261), k3 = c2(54290), l = c2(85328), m2 = c2(38928), n = c2(46595), o = c2(3421), p2 = c2(17679), q3 = c2(41681), r = c2(63446), s = c2(86439), t = c2(51356), u = c2(48689), v2 = c2(91132), w3 = c2(66147);
          async function x3(a3, { params: b5 }) {
            let c3 = await (0, w3.K5)(a3);
            if (!(0, w3.oC)(c3)) return new Response("Not authenticated", { status: 401 });
            let { id: d2 } = await b5, e2 = (0, v2.qK)(), f2 = (0, v2.nk)();
            if (!e2 || !f2) return new Response("Storage unavailable", { status: 503 });
            let g3 = (0, v2.Lf)(e2), h2 = await g3.select().from(v2.Ww).where((0, u.eq)(v2.Ww.id, d2)).get(), i2 = h2?.paymentScreenshotUrl;
            if (!i2) return new Response("Payment proof not found", { status: 404 });
            if (/^https?:\/\//.test(i2)) return Response.redirect(i2, 302);
            let j4 = await f2.get(i2);
            if (!j4) return new Response("File not found in storage", { status: 404 });
            let k4 = new Headers();
            return k4.set("Content-Type", j4.httpMetadata?.contentType || "application/octet-stream"), k4.set("Cache-Control", "private, max-age=60"), j4.size && k4.set("Content-Length", String(j4.size)), new Response(j4.body, { headers: k4 });
          }
          __name(x3, "x3");
          let y3 = new e.AppRouteRouteModule({ definition: { kind: f.RouteKind.APP_ROUTE, page: "/api/admin/orders/[id]/payment-proof/route", pathname: "/api/admin/orders/[id]/payment-proof", filename: "route", bundlePath: "app/api/admin/orders/[id]/payment-proof/route" }, distDir: ".next", relativeProjectDir: "", resolvedPagePath: "/home/asifnawaz/git/dermaup-hair-oil/app/api/admin/orders/[id]/payment-proof/route.ts", nextConfigOutput: "standalone", userland: d }), { workAsyncStorage: z3, workUnitAsyncStorage: A2, serverHooks: B2 } = y3;
          function C2() {
          ...
          async function D2(a3, b5, c3) {
            var d2;
            let e2 = "/api/admin/orders/[id]/payment-proof/route";
            e2 === "/index" && (e2 = "/");
