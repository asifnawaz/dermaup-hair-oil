...
// Deployed source path: /home/asifnawaz/git/dermaup-hair-oil/app/api/admin/subscribers/route.ts
// Project-relative source path: app/api/admin/subscribers/route.ts
// Module ID: 38908
// Deployment location(s): dist/worker.js
// Captured factory SHA-256: f6d215e3bc83e702aee0e7cac90885dbf62e5dac87c904b608be2adbff8aed69
...
((a2, b4, c2) => {
          ...
          var e = c2(95736), f = c2(9117), g2 = c2(4044), h = c2(39326), i = c2(32324), j3 = c2(261), k3 = c2(54290), l = c2(85328), m2 = c2(38928), n = c2(46595), o = c2(3421), p2 = c2(17679), q3 = c2(41681), r = c2(63446), s = c2(86439), t = c2(51356), u = c2(10641), v2 = c2(48689), w3 = c2(69334), x3 = c2(71559), y3 = c2(91132), z3 = c2(66147);
          async function A2(a3) {
            ...
            try {
              let { searchParams: b6 } = new URL(a3.url), c3 = parseInt(b6.get("page") || "1"), d2 = parseInt(b6.get("limit") || "20"), e2 = b6.get("search") || "", f2 = b6.get("source") || "", g3 = (c3 - 1) * d2, h2 = (0, y3.qK)();
              if (!h2) return u.NextResponse.json({ success: true, data: { subscribers: [], pagination: { page: 1, limit: 20, total: 0, totalPages: 0 } } });
              let i2 = (0, y3.Lf)(h2), j4 = [];
              if (e2) {
                let a4 = (0, v2.or)((0, v2.mj)(y3._s.email, `%${e2}%`), (0, v2.mj)(y3._s.name, `%${e2}%`), (0, v2.mj)(y3._s.phone, `%${e2}%`));
                a4 && j4.push(a4);
              }
              f2 && j4.push((0, v2.eq)(y3._s.source, f2));
              let k4 = j4.length === 0 ? void 0 : j4.length === 1 ? j4[0] : (0, v2.Uo)(...j4), l2 = i2.select({ count: (0, w3.U9)() }).from(y3._s), m3 = k4 ? await l2.where(k4).get() : await l2.get(), n2 = m3?.count || 0, o2 = i2.select().from(y3._s), p3 = await (k4 ? o2.where(k4) : o2).orderBy((0, x3.i)(y3._s.subscribedAt)).limit(d2).offset(g3).all();
              return u.NextResponse.json({ success: true, data: { subscribers: p3, pagination: { page: c3, limit: d2, total: n2, totalPages: Math.ceil(n2 / d2) } } });
            } catch (a4) {
              return console.error("Subscribers list error:", a4), u.NextResponse.json({ success: false, error: "Failed to fetch subscribers" }, { status: 500 });
            }
          }
          __name(A2, "A2");
          let B2 = new e.AppRouteRouteModule({ definition: { kind: f.RouteKind.APP_ROUTE, page: "/api/admin/subscribers/route", pathname: "/api/admin/subscribers", filename: "route", bundlePath: "app/api/admin/subscribers/route" }, distDir: ".next", relativeProjectDir: "", resolvedPagePath: "/home/asifnawaz/git/dermaup-hair-oil/app/api/admin/subscribers/route.ts", nextConfigOutput: "standalone", userland: d }), { workAsyncStorage: C2, workUnitAsyncStorage: D2, serverHooks: E2 } = B2;
          function F2() {
          ...
          async function G3(a3, b5, c3) {
            var d2;
            let e2 = "/api/admin/subscribers/route";
            e2 === "/index" && (e2 = "/");
