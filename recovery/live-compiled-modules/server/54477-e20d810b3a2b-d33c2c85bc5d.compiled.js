...
// Deployed source path: /home/asifnawaz/git/dermaup-hair-oil/app/api/admin/media/[id]/file/route.ts
// Project-relative source path: app/api/admin/media/[id]/file/route.ts
// Module ID: 54477
// Deployment location(s): dist/worker.js
// Captured factory SHA-256: d33c2c85bc5d69efe813ec98166d99ad735e8938999559dc9dff8735b0780dbe
...
((a2, b4, c2) => {
          ...
          var d = {};
          c2.r(d), c2.d(d, { GET: /* @__PURE__ */ __name(() => y3, "GET") });
          ...
          async function y3(a3, { params: b5 }) {
            ...
            let { id: d2 } = await b5, e2 = (0, w3.qK)();
            if (!e2) return new Response("DB not available", { status: 500 });
            let f2 = (0, w3.Lf)(e2), [g3] = await f2.select().from(w3.$_).where((0, v2.eq)(w3.$_.id, d2)).all();
            if (!g3) return new Response("Not found", { status: 404 });
            let h2 = (0, w3.nk)();
            if (!h2) return new Response("Media bucket not available", { status: 500 });
            let i2 = await h2.get(g3.key);
            if (!i2) return new Response("File not found in storage", { status: 404 });
            let j4 = new Headers();
            return j4.set("Content-Type", g3.mimeType), j4.set("Cache-Control", "public, max-age=31536000, immutable"), i2.size && j4.set("Content-Length", String(i2.size)), new Response(i2.body, { headers: j4 });
          }
          __name(y3, "y3");
          let z3 = new e.AppRouteRouteModule({ definition: { kind: f.RouteKind.APP_ROUTE, page: "/api/admin/media/[id]/file/route", pathname: "/api/admin/media/[id]/file", filename: "route", bundlePath: "app/api/admin/media/[id]/file/route" }, distDir: ".next", relativeProjectDir: "", resolvedPagePath: "/home/asifnawaz/git/dermaup-hair-oil/app/api/admin/media/[id]/file/route.ts", nextConfigOutput: "standalone", userland: d }), { workAsyncStorage: A2, workUnitAsyncStorage: B2, serverHooks: C2 } = z3;
          function D2() {
          ...
          async function E2(a3, b5, c3) {
            var d2;
            let e2 = "/api/admin/media/[id]/file/route";
            e2 === "/index" && (e2 = "/");
