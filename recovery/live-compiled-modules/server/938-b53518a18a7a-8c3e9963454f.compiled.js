...
// Deployed source path: /home/asifnawaz/git/dermaup-hair-oil/app/api/admin/content/blocks/[id]/route.ts
// Project-relative source path: app/api/admin/content/blocks/[id]/route.ts
// Module ID: 938
// Deployment location(s): dist/worker.js
// Captured factory SHA-256: 8c3e9963454f26ac5d5c9333d0bdbeddf22557216c982a26f6b796493a10bccc
...
((a2, b4, c2) => {
          ...
          async function A2(a3, { params: b5 }) {
            ...
            let { id: d2 } = await b5, e2 = (0, x3.qK)();
            if (!e2) return u.NextResponse.json({ success: false, error: "DB not available" }, { status: 500 });
            let f2 = (0, x3.Lf)(e2), g3 = await f2.select().from(x3.Id).where((0, w3.eq)(x3.Id.id, d2)).get();
            return g3 ? u.NextResponse.json({ success: true, data: { ...g3, parsedData: (0, z3.$)(g3.data) } }) : u.NextResponse.json({ success: false, error: "Not found" }, { status: 404 });
          }
          __name(A2, "A2");
          async function B2(a3, { params: b5 }) {
            ...
            let { id: d2 } = await b5, e2 = (0, x3.qK)();
            if (!e2) return u.NextResponse.json({ success: false, error: "DB not available" }, { status: 500 });
            let f2 = (0, x3.Lf)(e2), g3 = await a3.json(), h2 = await f2.select().from(x3.Id).where((0, w3.eq)(x3.Id.id, d2)).get(), i2 = { updatedAt: (/* @__PURE__ */ new Date()).toISOString() };
            g3.type !== void 0 && (i2.type = g3.type), g3.slug !== void 0 && (i2.slug = g3.slug), g3.productId !== void 0 && (i2.productId = g3.productId), g3.data !== void 0 && (i2.data = JSON.stringify(g3.data)), g3.active !== void 0 && (i2.active = g3.active), g3.sortOrder !== void 0 && (i2.sortOrder = g3.sortOrder), await f2.update(x3.Id).set(i2).where((0, w3.eq)(x3.Id.id, d2));
            let j4 = await f2.select().from(x3.Id).where((0, w3.eq)(x3.Id.id, d2)).get();
            return h2 && ((0, v2.revalidateTag)(`blocks:${h2.type}`), h2.productId && (0, v2.revalidateTag)(`all-blocks:${h2.productId}`)), j4 && ((0, v2.revalidateTag)(`blocks:${j4.type}`), j4.productId && (0, v2.revalidateTag)(`all-blocks:${j4.productId}`)), u.NextResponse.json({ success: true });
          }
          __name(B2, "B2");
          async function C2(a3, { params: b5 }) {
            ...
            if (!e2) return u.NextResponse.json({ success: false, error: "DB not available" }, { status: 500 });
            let f2 = (0, x3.Lf)(e2), g3 = await f2.select().from(x3.Id).where((0, w3.eq)(x3.Id.id, d2)).get();
            return await f2.delete(x3.Id).where((0, w3.eq)(x3.Id.id, d2)), g3 && ((0, v2.revalidateTag)(`blocks:${g3.type}`), g3.productId && (0, v2.revalidateTag)(`all-blocks:${g3.productId}`)), u.NextResponse.json({ success: true });
          }
          __name(C2, "C2");
          let D2 = new e.AppRouteRouteModule({ definition: { kind: f.RouteKind.APP_ROUTE, page: "/api/admin/content/blocks/[id]/route", pathname: "/api/admin/content/blocks/[id]", filename: "route", bundlePath: "app/api/admin/content/blocks/[id]/route" }, distDir: ".next", relativeProjectDir: "", resolvedPagePath: "/home/asifnawaz/git/dermaup-hair-oil/app/api/admin/content/blocks/[id]/route.ts", nextConfigOutput: "standalone", userland: d }), { workAsyncStorage: E2, workUnitAsyncStorage: F2, serverHooks: G3 } = D2;
          function H3() {
          ...
          async function I3(a3, b5, c3) {
            var d2;
            let e2 = "/api/admin/content/blocks/[id]/route";
            e2 === "/index" && (e2 = "/");
