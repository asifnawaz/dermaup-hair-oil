...
// Deployed source path: /home/asifnawaz/git/dermaup-hair-oil/app/favicon.ico/route.ts
// Project-relative source path: app/favicon.ico/route.ts
// Module ID: 82567
// Deployment location(s): dist/worker.js
// Captured factory SHA-256: 9232735b4858c6f81f3d69275bb5980c9b184dc72b8fb7e48ba62829ca9cc5ca
// The factory below is preserved as data and is not executed by the extractor.

((a2, b4, c2) => {
          "use strict";
          c2.r(b4), c2.d(b4, { handler: /* @__PURE__ */ __name(() => B2, "handler"), patchFetch: /* @__PURE__ */ __name(() => A2, "patchFetch"), routeModule: /* @__PURE__ */ __name(() => w3, "routeModule"), serverHooks: /* @__PURE__ */ __name(() => z3, "serverHooks"), workAsyncStorage: /* @__PURE__ */ __name(() => x3, "workAsyncStorage"), workUnitAsyncStorage: /* @__PURE__ */ __name(() => y3, "workUnitAsyncStorage") });
          var d = {};
          c2.r(d), c2.d(d, { GET: /* @__PURE__ */ __name(() => v2, "GET") });
          ...
          function v2(a3) {
            return u.NextResponse.redirect(new URL("/icon.svg", a3.url), 308);
          }
          __name(v2, "v2");
          let w3 = new e.AppRouteRouteModule({ definition: { kind: f.RouteKind.APP_ROUTE, page: "/favicon.ico/route", pathname: "/favicon.ico", filename: "route", bundlePath: "app/favicon.ico/route" }, distDir: ".next", relativeProjectDir: "", resolvedPagePath: "/home/asifnawaz/git/dermaup-hair-oil/app/favicon.ico/route.ts", nextConfigOutput: "standalone", userland: d }), { workAsyncStorage: x3, workUnitAsyncStorage: y3, serverHooks: z3 } = w3;
          function A2() {
            return (0, g2.patchFetch)({ workAsyncStorage: x3, workUnitAsyncStorage: y3 });
          }
          __name(A2, "A2");
          async function B2(a3, b5, c3) {
            var d2;
            let e2 = "/favicon.ico/route";
            e2 === "/index" && (e2 = "/");
            let g3 = await w3.prepare(a3, b5, { srcPage: e2, multiZoneDraftMode: false });
            if (!g3) return b5.statusCode = 400, b5.end("Bad Request"), c3.waitUntil == null || c3.waitUntil.call(c3, Promise.resolve()), null;
            let { buildId: u2, params: v3, nextConfig: x4, isDraftMode: y4, prerenderManifest: z4, routerServerContext: A3, isOnDemandRevalidate: B3, revalidateOnlyGenerated: C2, resolvedPathname: D2 } = g3, E2 = (0, j3.normalizeAppPath)(e2), F2 = !!(z4.dynamicRoutes[E2] || z4.routes[D2]);
            if (F2 && !y4) {
              let a4 = !!z4.routes[D2], b6 = z4.dynamicRoutes[E2];
              if (b6 && b6.fallback === false && !a4) throw new s.NoFallbackError();
            }
            let G3 = null;
            !F2 || w3.isDev || y4 || (G3 = (G3 = D2) === "/index" ? "/" : G3);
            let H3 = w3.isDev === true || !F2, I3 = F2 && !H3, J2 = a3.method || "GET", K3 = (0, i.getTracer)(), L3 = K3.getActiveScopeSpan(), M3 = { params: v3, prerenderManifest: z4, renderOpts: { experimental: { cacheComponents: !!x4.experimental.cacheComponents, authInterrupts: !!x4.experimental.authInterrupts }, supportsDynamicResponse: H3, incrementalCache: (0, h.getRequestMeta)(a3, "incrementalCache"), cacheLifeProfiles: (d2 = x4.experimental) == null ? void 0 : d2.cacheLife, isRevalidate: I3, waitUntil: c3.waitUntil, onClose: /* @__PURE__ */ __name((a4) => {
              b5.on("close", a4);
            }, "onClose"), onAfterTaskError: void 0, onInstrumentationRequestError: /* @__PURE__ */ __name((b6, c4, d3) => w3.onRequestError(a3, b6, d3, A3), "onInstrumentationRequestError") }, sharedContext: { buildId: u2 } }, N3 = new k3.NodeNextRequest(a3), O3 = new k3.NodeNextResponse(b5), P2 = l.NextRequestAdapter.fromNodeNextRequest(N3, (0, l.signalFromNodeResponse)(b5));
            try {
              let d3 = /* @__PURE__ */ __name(async (c4) => w3.handle(P2, M3).finally(() => {
                if (!c4) return;
                ...
                let k4 = /* @__PURE__ */ __name(async ({ previousCacheEntry: f2 }) => {
                  try {
                    if (!(0, h.getRequestMeta)(a3, "minimalMode") && B3 && C2 && !f2) return b5.statusCode = 404, b5.setHeader("x-nextjs-cache", "REVALIDATED"), b5.end("This page could not be found"), null;
                    let e3 = await d3(g5);
                    ...
                    throw f2?.isStale && await w3.onRequestError(a3, b6, { routerKind: "App Router", routePath: e2, routeType: "route", revalidateReason: (0, n.c)({ isRevalidate: I3, isOnDemandRevalidate: B3 }) }, A3), b6;
                  }
                }, "k4"), l2 = await w3.handleResponse({ req: a3, nextConfig: x4, cacheKey: G3, routeKind: f.RouteKind.APP_ROUTE, isFallback: false, prerenderManifest: z4, isRoutePPREnabled: false, isOnDemandRevalidate: B3, revalidateOnlyGenerated: C2, responseGenerator: k4, waitUntil: c3.waitUntil });
                if (!F2) return null;
              ...
              if (b6 instanceof s.NoFallbackError || await w3.onRequestError(a3, b6, { routerKind: "App Router", routePath: E2, routeType: "route", revalidateReason: (0, n.c)({ isRevalidate: I3, isOnDemandRevalidate: B3 }) }), F2) throw b6;
