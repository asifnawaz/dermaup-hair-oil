...
// Deployed source path: /home/asifnawaz/git/dermaup-hair-oil/app/api/admin/auth/me/route.ts
// Project-relative source path: app/api/admin/auth/me/route.ts
// Module ID: 83444
// Deployment location(s): dist/worker.js
// Captured factory SHA-256: 9236ebaa780f257f6301034e13fed49aedefd12df1ca38016b0a855619d415d5
...
((a2, b4, c2) => {
          ...
          var d = {};
          c2.r(d), c2.d(d, { GET: /* @__PURE__ */ __name(() => w3, "GET") });
          ...
          async function w3(a3) {
            let b5 = await (0, v2.K5)(a3);
            return b5 ? u.NextResponse.json({ success: true, data: { user: b5 } }) : u.NextResponse.json({ success: false, error: "Not authenticated" }, { status: 401 });
          }
          __name(w3, "w3");
          let x3 = new e.AppRouteRouteModule({ definition: { kind: f.RouteKind.APP_ROUTE, page: "/api/admin/auth/me/route", pathname: "/api/admin/auth/me", filename: "route", bundlePath: "app/api/admin/auth/me/route" }, distDir: ".next", relativeProjectDir: "", resolvedPagePath: "/home/asifnawaz/git/dermaup-hair-oil/app/api/admin/auth/me/route.ts", nextConfigOutput: "standalone", userland: d }), { workAsyncStorage: y3, workUnitAsyncStorage: z3, serverHooks: A2 } = x3;
          function B2() {
          ...
          async function C2(a3, b5, c3) {
            var d2;
            let e2 = "/api/admin/auth/me/route";
            e2 === "/index" && (e2 = "/");
